#ifndef ORGANISM_NN_H
#define ORGANISM_NN_H
...
#define NUM_OUTPUTS_NN NUM_LEGS*3*FOURIER_PARAMS
...
public:
	...
	// CONSTRUCTOR
	organism_nn (bool init_random=false)
	{
		iter = 0;
		alloc = false;
		if (init_random)
	...
	organism_nn* makeBabyWith (organism_nn *mate, float mutation)
	{
		int ii, ij, ik;
	...
	organism_nn* clone (float mutation)
	{
		int ii, ij, ik;
		int common, common2, common3;
		organism_nn *ret;
